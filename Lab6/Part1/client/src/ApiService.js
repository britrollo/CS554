...
class ApiService {
    ...
    async mutationGraphQlData(resource, params, fields) {
    ...
    async createTodo(params){
        const data = await this.mutationGraphQlData('createTodo', params, this.todoFields);
        //return todos list
        return data.createTodos;
    }

    async updateTodo(params){
        const data = await this.mutationGraphQlData('updateTodo', params, this.todoFields);
        //return todos list
        return data.updateTodos;
    }

    async deleteTodo(params){
        const data = await this.mutationGraphQlData('deleteTodo', params, this.todoFields);
        //return todos list
